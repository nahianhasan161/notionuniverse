  ...
  return (
    <section className="py-[220px]">
      <div className="container">
        <div className="row">
          <div className="wpb_column column_container col-sm-12 md:mt-[10rem]">
                        ...
                        <div className="wpb_text_column wpb_content_element padding-box-2 text-light">
                          <div className="wpb_wrapper">
                            <p>
                              ...
                              compassionate debt recovery solutions, our mission
                              is to assist individuals in overcoming financial
                              challenges, restoring their peace of mind, and
                              enabling them to step confidently towards a
                              brighter, debt-free future.
                            </p>
                          </div>
                        </div>
                      </div>
